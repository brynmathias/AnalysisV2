...
fit_info* draw_tree(double cut, double step) {
  ...
  TString weight="1"; // scale to 1pb-1
  TString no_we="1";
  // Start plotting
  ...
  TH1D *hSelection=plotIso(tSig,"alphaT","wgt",etCut+theHT+" && nEle==1",theEta,
			   "nJet>=1 && et_j1>40.","sel","(100,0.,2.)",1.,1);
  TH1D *hW=plotIso(tW,"alphaT","wgt",etCut+theHT+" && nEle==1",theEta,
			   "nJet>=1 && et_j1>40.","w","(100,0.,2.)",1.,1);
  TH1D *hControl=plotIso(tCtrl,"alphaT","wgt",etCut+theHT+" && nEle==1",theEta,
			   "nJet>=1 && et_j1>40.","ctrl","(100,0.,2.)",1.,3);
  TH1D *hConversions=plotIsoConv(tSig,"alphaT","wgt",etCut+theHT+" && nEle==1",theEta,
