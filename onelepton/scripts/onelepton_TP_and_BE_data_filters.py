...
#MuHad_May10ReReco_deadecal_ps = getDeadECALList("../python/deadecal/veto_MuHad_Run2011_filteredEventsBE.py")
#MuHad_May10ReReco_deadecal_ps._quiet_set("Accept", False)
#MuHad_allBE_deadecal_Cut = EventSelector(MuHad_May10ReReco_deadecal_ps.ps())

tt_Pythia6_ps = getDeadECALList("../python/pythia6bug/tt_pythiaFilterList.py")
tt_Pythia6_ps._quiet_set("Accept", False)
tt_Pythia6_Cut = EventSelector(tt_Pythia6_ps.ps())


w_Pythia6_ps = getDeadECALList("../python/pythia6bug/w_pythiaFilterList.py")
w_Pythia6_ps._quiet_set("Accept", False)
