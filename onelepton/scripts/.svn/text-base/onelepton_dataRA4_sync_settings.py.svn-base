...
conf.Common.Jets.TightID=False ## DOES NOT MEAN ID is NOT applied
conf.Common.Jets.ApplyID=False ## DOES NOT MEAN ID is NOT applied
# muons
conf.Common.Muons.EtaCut = 2.1
conf.Common.Muons.PtCut = 20.0
conf.Common.Muons.TrkIsoCut=999999.
## conf.Common.Muons.CombIsoCut=0.1 ##GETS OVERWRITTEN ANYHOW
