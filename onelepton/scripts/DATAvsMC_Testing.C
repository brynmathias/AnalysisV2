...
// Create Canvases and Plots
  ...
  for(unsigned int i=0; i<folderNames.size(); i++) {
    if(plots.count("LP_pos")>0) { 
      createDataVsMC(folderNames[i],"LP_pos",10*rebinFactor[i],-0.5,1.5,"L_{P}[+]","Entries / bin",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    } 
    if(plots.count("LP_neg")>0) {    	
      createDataVsMC(folderNames[i],"LP_neg",10*rebinFactor[i],-0.5,1.5,"L_{P}[-]","Entries / bin",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    } 
    if(plots.count("LPf_tot")>0) { 
      createDataVsMC(folderNames[i],"LPf_tot",1*rebinFactor[i],-0.5,1.5,"L_{P}","Events / 0.15",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++; 
    } 
  }
  for(unsigned int i=0; i<folderNames.size(); i++) {
  ...
  for(unsigned int i=0; i<folderNames.size(); i++) {
    ...
    if(plots.count("MTf_tot")>0) {
      createDataVsMC(folderNames[i],"MTf_tot",1*rebinFactor[i],0,300,"M_{T} [GeV]","Events / 10 GeV",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    }
  }
  for(unsigned int i=0; i<folderNames.size(); i++) { 
    if(plots.count("SumLepPt_pos")>0) {
      createDataVsMC(folderNames[i],"SumLepPt_pos",20*rebinFactor[i],0,1000,"S_{T}^{lep}[+]","Entries / bin",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    } 
    if(plots.count("SumLepPt_neg")>0) {
      createDataVsMC(folderNames[i],"SumLepPt_neg",20*rebinFactor[i],0,1000,"ST_{lep}[-]","Entries / bin",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    } 
    if(plots.count("STf_tot")>0) {
      createDataVsMC(folderNames[i],"STf_tot",1*rebinFactor[i],150,300,"S_{T}^{lep} [GeV]","Events / 50 GeV",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    }
  }
  for(unsigned int i=0; i<folderNames.size(); i++) { 
  ...
  for(unsigned int i=0; i<folderNames.size(); i++) { 
    if(plots.count("LepPt_pos")>0) {
      createDataVsMC(folderNames[i],"LepPt_pos",15*rebinFactor[i],0,500,"LepPt[+]","Entries / bin",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    } 
    if(plots.count("LepPt_neg")>0) {
      createDataVsMC(folderNames[i],"LepPt_neg",15*rebinFactor[i],0,500,"LepPt[-]","Entries / bin",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    } 
    if(plots.count("LepPtf_tot")>0) {
      createDataVsMC(folderNames[i],"LepPtf_tot",1*rebinFactor[i],0,300,"p_{T}(lep) [GeV]","Events / 20 GeV",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    }
  }
  for(unsigned int i=0; i<folderNames.size(); i++) { 
    if(plots.count("PFMET_pos")>0) {
      createDataVsMC(folderNames[i],"PFMET_pos",20*rebinFactor[i],0,1000,"PFMET[+]","Entries / bin",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    } 
    if(plots.count("PFMET_neg")>0) {
      createDataVsMC(folderNames[i],"PFMET_neg",20*rebinFactor[i],0,1000,"PFMET[-]","Entries / bin",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    } 
    if(plots.count("PFMET_tot")>0) {
      createDataVsMC(folderNames[i],"PFMET_tot",20*rebinFactor[i],0,1000,"PFMET","Entries / bin",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    }
  }
  for(unsigned int i=0; i<folderNames.size(); i++) { 
    if(plots.count("PFMHT_pos")>0) {
      createDataVsMC(folderNames[i],"PFMHT_pos",20*rebinFactor[i],0,1000,"PFMHT[+]","Entries / bin",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    } 
    if(plots.count("PFMHT_neg")>0) {
      createDataVsMC(folderNames[i],"PFMHT_neg",20*rebinFactor[i],0,1000,"PFMHT[-]","Entries / bin",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    } 
    if(plots.count("PFMHT_tot")>0) {
      createDataVsMC(folderNames[i],"PFMHT_tot",20*rebinFactor[i],0,1000,"PFMHT","Entries / bin",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    } 
  }
  ...
  for(unsigned int i=0; i<folderNames.size(); i++) {
    if(plots.count("HT_tot")>0) {
      createDataVsMC(folderNames[i],"HT_tot",20*rebinFactor[i],0.,1000.,"H_{T} [GeV]","Entries / bin",MCFileNames,MCNames,MCColors,AddToBkg,dataFileNames,dataNames,dataColors,SystNames,SystColors,Canvases[plotNr/Parameters.HistosPerCanvas],plotNr%Parameters.HistosPerCanvas,false,Parameters);
      plotNr++;
    } 
  }
