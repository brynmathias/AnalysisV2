...
ctrl.AddMuonFilter("PreCC",PF_MU_ID)
ctrl.AddElectronFilter("PreCC",PF_ELE_ID)
...
samples=[LM0,LM1,QCD_AllPtBins_7TeV_Pythia,em_20to30,em_30to80,em_80to170,bce_20to30,bce_30to80,bce_80to170,zjets_madgraph,ttbarTauola,Wj]
#samples=[bce_30to80]
