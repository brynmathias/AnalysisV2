...
extra = "110125"+optionStr+"/"+str(int(pt1_default))+"_"+str(int(pt2_default))+"_"+str(int(pt3_default))+"/"
dir = dir+extra
print dir
...
cutTreeMC.TAttach(oddMuon,dalitzMC)
...
conf_ak5_caloMC.Ntuple = deepcopy(default_ntuple)
