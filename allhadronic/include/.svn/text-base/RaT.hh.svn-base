#ifndef allhadronic_include_RaT_hh
#define allhadronic_include_RaT_hh
...
namespace Operation {
  ...
  class RaT : public PlottingBase {
    
  public:
    
    RaT( const Utils::ParameterSet& );
    ~RaT();
  ...
  private:
    ...
    vTH1D hGenMet_;
    vTH1D hGenJetMht_;
    vTH2D hGenMetVsGenNuPtMax_;
    vTH2D hGenMetVsGenNuMet_;
    vTH2D hGenJetMhtVsGenNuMet_;
    vTH2D hGenJetMhtVsGenMuMet_;
    vTH2D hGenJetMhtVsGenElMet_;
    vTH2D hGenJetMhtVsGenPhMet_;
    vTH2D hSMS_;
    bool cutFlowHistos_;
    vvTH1D hCutFlow_;
    bool htHistos_;
...
#endif // allhadronic_include_RaT_hh
