#ifndef allhadronic_include_Scaling_hh
#define allhadronic_include_Scaling_hh
...
namespace allhadronic {
  ...
  */
  class Scaling : public PlottingBaseExtended {
    
  public:
    
    
    Scaling( const Utils::ParameterSet& );
    ~Scaling();
...
#endif // allhadronic_include_Scaling_hh
