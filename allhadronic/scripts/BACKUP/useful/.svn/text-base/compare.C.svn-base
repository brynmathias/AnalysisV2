...
int overlay() {
  ...
  /*
    ...
    "HistoDir"
    Rebin histograms?
    Normalize all histograms to QCD 
    Logarithmic y-scale
    Output TFile
  */  
  
  TString path = "../RESULTS/8-MHTratioFixed/";
  
  if (0) {
    aDrawBkgdPlots( path, "LeadingJetEta", "Eta_1", "Hadronic", 10, false, true, output );
    aDrawBkgdPlots( path, "SecondJetEta", "Eta_2", "Hadronic", 10, false, true, output );
    aDrawBkgdPlots( path, "DeltaEta", "DeltaEta_1", "Hadronic", 10, false, true, output );
    aDrawBkgdPlots( path, "DeltaR", "DeltaR_1", "Hadronic", 10, false, true, output );
    aDrawBkgdPlots( path, "LeadingJetEtaNorm", "Eta_1", "Hadronic", 10, true, true, output );
    aDrawBkgdPlots( path, "SecondJetEtaNorm", "Eta_2", "Hadronic", 10, true, true, output );
    aDrawBkgdPlots( path, "DeltaEtaNorm", "DeltaEta_1", "Hadronic", 10, true, true, output );
    aDrawBkgdPlots( path, "DeltaRNorm", "DeltaR_1", "Hadronic", 10, true, true, output );
  }
  
  if (1) {
    aDrawBkgdPlots( path, "AlphaT", "AlphaT_0", "KinSuiteComPlot", 5, false, true, output );
    aDrawBkgdPlots( path, "AlphaTzoom", "AlphaT_0", "KinSuiteComPlot", 1, false, true, output );
    aDrawBkgdPlots( path, "JetMultiplicity", "JetMultiplicity", "CommonPlotsPost", 1, false, true, output );
    aDrawBkgdPlots( path, "HT", "SumEtall", "CommonPlotsPost", 10, false, true, output );
    aDrawBkgdPlots( path, "MHT", "MHTall", "CommonPlotsPost", 10, false, true, output );
    aDrawBkgdPlots( path, "DeltaPhi_MPT_MHT", "MPTMHTdPhi", "CommonPlotsPost", 2, false, true, output );
    aDrawBkgdPlots( path, "BiasedDPhi", "biasedJetMHTdPhiall", "CommonPlotsPost", 2, false, true, output );
  }
