...
default_common.Jets.PtCut=40.0
...
alphaTnumbers150_1 =   TriggerEffPlots( PSet(DirName = "alphaTnumbers150_1",MinObjects =0 ,MaxObjects = 15,EffPlots = True).ps() )
alphaTnumbers200_1 =   TriggerEffPlots( PSet(DirName = "alphaTnumbers200_1",MinObjects =0 ,MaxObjects = 15,EffPlots = True).ps() )
alphaTnumbers250_1 =   TriggerEffPlots( PSet(DirName = "alphaTnumbers250_1",MinObjects =0 ,MaxObjects = 15,EffPlots = True).ps() )
alphaTnumbers300_1 =   TriggerEffPlots( PSet(DirName = "alphaTnumbers300_1",MinObjects =0 ,MaxObjects = 15,EffPlots = True).ps() )
...
AtTrigger =  OP_AlphaTriggerCut(0.6,150.,40.,40.)
AtTrigger_1 =  OP_AlphaTriggerCut(0.6,150.,40.,80.)
cutTreeData.TAttach(secondJetET,htCut150)
...
cutTreeData.FAttach(AtTrigger,AtTrigger_1)
cutTreeData.TAttach(AtTrigger_1,alphaTnumbers150_1)
AtTrigger1 =  OP_AlphaTriggerCut(0.6,150.,40.,40.)
AtTrigger1_1 =  OP_AlphaTriggerCut(0.6,150.,40.,80.)
cutTreeData.TAttach(secondJetET,htCut200)
cutTreeData.TAttach(htCut200,NoTriggerPlots200)
cutTreeData.TAttach(htCut200,AtTrigger1)
cutTreeData.FAttach(AtTrigger1,AtTrigger1_1)
cutTreeData.TAttach(AtTrigger1_1,alphaTnumbers200_1)
cutTreeData.TAttach(AtTrigger1,alphaTnumbers200)
AtTrigger2 =  OP_AlphaTriggerCut(0.6,150.,40.,40.)
AtTrigger2_1 =  OP_AlphaTriggerCut(0.6,150.,40.,80.)
...
cutTreeData.FAttach(AtTrigger2,AtTrigger2_1)
cutTreeData.TAttach(AtTrigger2_1,alphaTnumbers250_1)
AtTrigger3 =  OP_AlphaTriggerCut(0.6,150.,40.,40.)
AtTrigger3_1 =  OP_AlphaTriggerCut(0.6,150.,40.,80.)
...
cutTreeData.FAttach(AtTrigger3,AtTrigger3_1)
cutTreeData.TAttach(AtTrigger3,alphaTnumbers300)
cutTreeData.TAttach(AtTrigger3_1,alphaTnumbers300_1)