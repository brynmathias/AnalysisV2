...
#include "eRooWPlusExtended.h" 
#include "RooAbsReal.h" 
#include "RooAbsCategory.h" 
#include <math.h> 
#include "TMath.h" 

ClassImp(eRooWPlusExtended) 

 eRooWPlusExtended::eRooWPlusExtended(const char *name, const char *title, 
                        RooAbsReal& _x,
                        RooAbsReal& _fL,
                        RooAbsReal& _fR,
                        RooAbsReal& _fs) :
 ...
 eRooWPlusExtended::eRooWPlusExtended(const eRooWPlusExtended& other, const char* name) :  
 ...
 Double_t eRooWPlusExtended::evaluate() const 
 { 
