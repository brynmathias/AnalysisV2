...
#include "RooWMinusExtended.h" 
#include "RooAbsReal.h" 
#include "RooAbsCategory.h" 
#include <math.h> 
#include "TMath.h" 

ClassImp(RooWMinusExtended) 

 RooWMinusExtended::RooWMinusExtended(const char *name, const char *title, 
                        RooAbsReal& _x,
                        RooAbsReal& _fL,
                        RooAbsReal& _fR,
                        RooAbsReal& _fs) :
 ...
 RooWMinusExtended::RooWMinusExtended(const RooWMinusExtended& other, const char* name) :  
 ...
 Double_t RooWMinusExtended::evaluate() const 
 { 
