...
#include "RooWPlusExtended.h" 
#include "RooAbsReal.h" 
#include "RooAbsCategory.h" 
#include <math.h> 
#include "TMath.h" 

ClassImp(RooWPlusExtended) 

 RooWPlusExtended::RooWPlusExtended(const char *name, const char *title, 
                        RooAbsReal& _x,
                        RooAbsReal& _fL,
                        RooAbsReal& _fR,
                        RooAbsReal& _fs) :
 ...
 RooWPlusExtended::RooWPlusExtended(const RooWPlusExtended& other, const char* name) :  
 ...
 Double_t RooWPlusExtended::evaluate() const 
 { 
