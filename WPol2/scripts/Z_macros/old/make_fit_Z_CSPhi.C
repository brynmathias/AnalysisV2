...
// Z templates
TString pHist1 = dir+"RECO_CSWMuon2PlusPhi_A";
TString pHist2 = dir+"RECO_CSWMuon2PlusPhi_B";
TString pHist3 = dir+"RECO_CSWMuon2PlusPhi_C";
// Z data
TString pHist_data = dir+"RECO_CSWMuon2PlusPhi";
...
void make_fit_Z_CSPhi(int chrg=+1, double scale=1., bool addqcd=0, bool smear=0, bool draw_contour=0, bool toymc=0, bool addqcdtodata=0) {
...
TFile *realdata = new TFile("./mc/test_newthetanewphi.root");
  ...
  // RooFit session
  RooRealVar *x = new RooRealVar("x","CS PhiStar variable",-3.55,3.45) ;
