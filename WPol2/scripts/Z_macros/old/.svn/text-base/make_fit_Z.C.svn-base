...
// Z templates
TString pHist1 = dir+"RECO_CosThetaStar1Sol1Plus_LH";
TString pHist2 = dir+"RECO_CosThetaStar1Sol1Plus_RH";
TString pHist3 = dir+"RECO_CosThetaStar1Sol1Plus_LO";
// Z data
TString pHist_data = dir+"RECO_CosThetaStar1Sol1Plus";
...
void make_fit_Z(int chrg=+1, double scale=1., bool addqcd=0, bool smear=0, bool draw_contour=0, bool toymc=0, bool addqcdtodata=0) {
...
//  TFile *realdata = new TFile("./mc/RecoRoutines_Z-selection_zjets_madgraph.root"); // WARNING: not real data!!!
  ...
  // RooFit session
  RooRealVar *x = new RooRealVar("x","CosThetaStar variable",-1,1) ;
