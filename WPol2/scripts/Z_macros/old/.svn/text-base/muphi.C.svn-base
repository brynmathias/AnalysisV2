...
void muphi(double zptcut=0, double ptmin=45, double lumiscale=0.36){
...
//setTDRStyle();
 ...
 TFile *data = new TFile("./RecoRoutines_Z-selection_zjets_madgraph_skim100pb.root","read"); 
  ...
  TString plottitle;
  if (charge>0) plottitle="RECO_0pcscale_MpPhivsMpPT_hrdMp";
  else plottitle="RECO_0pcscale_MmPhivsMmPT_hrdMm";
