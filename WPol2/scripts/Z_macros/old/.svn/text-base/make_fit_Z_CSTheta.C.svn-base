...
TString dir = "RECO_CSFramePlots_50toinf/";  
// Z templates
TString pHist1 = dir+"RECO_CSWMuon2PlusCosTheta_A";
TString pHist2 = dir+"RECO_CSWMuon2PlusCosTheta_B";
TString pHist3 = dir+"RECO_CSWMuon2PlusCosTheta_C";
// Z data
TString pHist_data = dir+"RECO_CSWMuon2PlusCosTheta";
...
void make_fit_Z_CSTheta(int chrg=+1, double scale=1., bool addqcd=0, bool smear=0, bool draw_contour=0, bool toymc=0, bool addqcdtodata=0) {
...
TFile *realdata = new TFile("./mc/test_newthetanewphi.root");
  ...
  // RooFit session
  RooRealVar *x = new RooRealVar("x","CS CosThetaStar variable",-1.5,1.5) ;
