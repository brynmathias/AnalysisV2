void getAiW() 
{
  //we don't have sensitivity to A0 and A4 because we don't know the sign of cos(theta_CS)
  TFile *data1 = new TFile("results/GenRoutines_WJets-lite_madgraph.root");
  ...
  TCanvas * aCanvas = new TCanvas("CSAiW", "CSAiW", 1100, 500);
