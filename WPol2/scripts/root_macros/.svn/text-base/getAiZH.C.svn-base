void getAiZH()
{  
  TFile *data1 = new TFile("../../../ICFv3SUSY/WPol/scripts/results/GenRoutines_ZJets_madgraph_June2010.root");
  ...
  TCanvas * aCanvas = new TCanvas("HAiZ", "HAiZ", 550, 500);
  ...
  hPA0->GetXaxis()->SetRangeUser(20,250);
...
/*
  ...
  hMA0->GetXaxis()->SetRangeUser(20,250);
...
*/
  ...
  //aCanvas->Print(".png");
  TFile *Output = new TFile("results/AiZH.root","RECREATE");
  aCanvas->Write();
  Output->Close();
