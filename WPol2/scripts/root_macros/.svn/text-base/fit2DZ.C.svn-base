void fit2D(void) {
  ofstream ai_params("ai_params_Zmadgraph.txt");
  ...
  //3. the moment method
  TFile *file0 = TFile::Open("../results/weight_mc_noptcut/WeightingRoutines_DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola.Spring11-PU_S1_START311_V1G1-v1.AODSIM.root");
  bool verbose = false;
