...
#include "JECUnc_SimpleJetCorrectionUncertainty.hh"
#include "JECUnc_JetCorrectorParameters.hh"
  ...
  for(unsigned i=0;i<fNames.size();i++)
    {
      if (fNames[i] == "JetEta")
        ...
        throw std::runtime_error("JetCorrectionUncertainty:: unknown parameter");
    }     
  return result;      
}
//------------------------------------------------------------------------ 
