...
cutTreeMSUGRA.TAttach(numComLeptons,numComPhotons)
...
cutTreeMSUGRA.TAttach(htCut250,LessThan400)
...
#HT > 350
cutTreeMSUGRA.TAttach(numComPhotons,htCut400)
cutTreeMSUGRA.TAttach(htCut400,plots_mSuGraScan_before_350)
...
#BatchRun(QCD,"anal_ak5_caloMC", "conf_ak5_caloMC","/vols/cms01/trommers/Haddata_Jamboree/",1000)
#BatchRun([Edward_Data_Skim],"anal_ak5_caloData","conf_ak5_caloData","/vols/cms01/trommers/Haddata_Jamboree/",20)
#anal_ak5_caloData.Run("../results_Jamboree",conf_ak5_caloData,[Edward_Data_Skim])
BatchRun([tanB3],"anal_ak5_caloMSUGRA","conf_ak5_caloMSUGRA","/vols/cms01/trommers/Haddata_Jamboree/",20)
BatchRun([tanB10],"anal_ak5_caloMSUGRA","conf_ak5_caloMSUGRA","/vols/cms01/trommers/Haddata_Jamboree/",20)


#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[wjets_madgraph_edwardSkim])
#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[zjets_madgraph_edwardSkim])
#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[Zinvisible_jets_edwardSkim])
#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[ttbarTauola])
#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[LM0])
#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[LM1])

#BatchRun(data, "anal_ak5_caloData", "conf_ak5_caloData","/vols/cms01/trommers/Haddata_Jamboree/",20)
#BatchRun([tanB3],"anal_ak5_caloMSUGRA","conf_ak5_caloMSUGRA","/vols/cms01/trommers/Haddata_Jamboree/",20)
#BatchRun([tanB10],"anal_ak5_caloMSUGRA","conf_ak5_caloMSUGRA","/vols/cms01/trommers/Haddata_Jamboree/",20)
#anal_ak5_caloMSUGRA.Run("../results_Jamboree",conf_ak5_caloMSUGRA,[tanB3])
#anal_ak5_caloMSUGRA.Run("../results_Jamboree",conf_ak5_caloMSUGRA,[tanB10])
#anal_ak5_caloData.Run("../results_Jamboree/",conf_ak5_caloData,data)
#
#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[LM2])
#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[LM3])
#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[LM4])
#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[LM5])

#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[wjets_madgraph])
#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[zjets_madgraph])
#
#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[Zinvisible_jets])
#anal_ak5_caloMC.Run("../results_Jamboree",conf_ak5_caloMC,[QCD_AllPtBins_7TeV_Pythia])

# anal_ak5_pfData.Run("../results/",conf_ak5_pfData,[allData])
# anal_ak5_pfMC.Run("../results",conf_ak5_pfMC,[LM0])
# anal_ak5_pfMC.Run("../results",conf_ak5_pfMC,[LM1])
# anal_ak5_pfMC.Run("../results",conf_ak5_pfMC,[LM2])
# anal_ak5_pfMC.Run("../results",conf_ak5_pfMC,[LM3])
# anal_ak5_pfMC.Run("../results",conf_ak5_pfMC,[LM4])
# anal_ak5_pfMC.Run("../results",conf_ak5_pfMC,[LM5])
# anal_ak5_pfMC.Run("../results",conf_ak5_pfMC,[QCD_AllPtBins_7TeV_Pythia])
# anal_ak5_pfMC.Run("../results",conf_ak5_pfMC,[wjets_madgraph])
# anal_ak5_pfMC.Run("../results",conf_ak5_pfMC,[zjets_madgraph])
# anal_ak5_pfMC.Run("../results",conf_ak5_pfMC,[ttbarTauola])
# anal_ak5_pfMC.Run("../results",conf_ak5_pfMC,[Zinvisible_jets])

# anal_ak5_jptData.Run("../results/",conf_ak5_jptData,[allData])
# anal_ak5_jptMC.Run("../results",conf_ak5_jptMC,[LM0])
# anal_ak5_jptMC.Run("../results",conf_ak5_jptMC,[LM1])
# anal_ak5_jptMC.Run("../results",conf_ak5_jptMC,[LM2])
# anal_ak5_jptMC.Run("../results",conf_ak5_jptMC,[LM3])
# anal_ak5_jptMC.Run("../results",conf_ak5_jptMC,[LM4])
# anal_ak5_jptMC.Run("../results",conf_ak5_jptMC,[LM5])
# anal_ak5_jptMC.Run("../results",conf_ak5_jptMC,[QCD_AllPtBins_7TeV_Pythia])
# anal_ak5_jptMC.Run("../results",conf_ak5_jptMC,[wjets_madgraph])
# anal_ak5_jptMC.Run("../results",conf_ak5_jptMC,[zjets_madgraph])
# anal_ak5_jptMC.Run("../results",conf_ak5_jptMC,[ttbarTauola])
# anal_ak5_jptMC.Run("../results",conf_ak5_jptMC,[Zinvisible_jets])
