...
genElVeto = OP_nGenElectrons("<=",0,10.,2.1)
genMuVeto = OP_nGenMuons("<=",0,10.,2.1)

cutTree = Tree("tree")
cutTree.Attach(genElVeto)
cutTree.TAttach(genElVeto,genMuVeto)
...
sample = PSet(Name = "Test",Format = ("ICF",3), File = "../CMSSM_Tanb10_1800_280.root",Weight = 1.)
