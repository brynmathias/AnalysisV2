...
NtupleData::NtupleData(const std::string & fileName,
    ...
    M0(mDataTree,"SimpModelScaM0",this),
    M12(mDataTree,"SimpModelScaM12",this),
    Mu(mDataTree,"SimpModelScaMu",this),
    SMSvalid(mDataTree,"SimpModelScanHandleValid",this),
    MChi(mDataTree,"SimpModelScanxCHI",this),
    MG(mDataTree,  "SimpModelScannmGL",this),
    MLSP(mDataTree,"SimpModelScannmLSP",this),
    TanBeta(mDataTree,"susyScantanbeta",this),
    MGluino(mDataTree, "SimpModelScanMassGluino", this),
    MSquark(mDataTree, "SimpModelScanMassSquark", this),
    MChi0(mDataTree, "SimpModelScanChi0", this),
