...
secondJetET275 = OP_SecondJetEtCut(100*(275./375.))
...
def MakeMuonDataTree(Threshold):
  ...
  tree = Tree("Main")
  tree.Attach(json)
  tree.TAttach(json,MuTrigger)
  tree.TAttach(MuTrigger,HBHE)
...
def MakeHadDataTree(Threshold):
  ...
  secondJetET = OP_SecondJetEtCut(Threshold)
  HTBins = []
  if int(Threshold) is 100 : HTBins = [375+100*i for i in range(3)]
  if int(Threshold) is 73 : HTBins = [275.,325.]
  if int(Threshold) is 86 : HTBins = [325.,375.]
  cutTreeData = Tree("Data")
  cutTreeData.Attach(json)
  cutTreeData.TAttach(json,MuTrigger)
  cutTreeData.TAttach(MuTrigger, selection)
