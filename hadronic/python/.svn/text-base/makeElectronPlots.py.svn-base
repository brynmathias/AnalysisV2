...
from ewpol.eWPolConfig import tight_id
...
data = [Skim_JetMET_Run2010A_ReReco_v2_Reco_Raw,Skim_JetMETTau_Run2010A_ReReco_v2_Reco_Raw,Skim_Jet_Run2010B_PromptReco_v2_Reco_Raw,Skim_Jet_Run2010B_PromptReco_v2_Reco_Raw_2,Skim_MultiJet_Run2010B_PromptReco_v2_Reco_Raw,Skim_MultiJet_Run2010B_PromptReco_v2_Reco_Raw_2]
MC = [
...
#EventNoDumpLargePFMET = OP_EventNoDump("LargeMHT,"LargeMHTHT")
...
anal_ak5_caloData.AddMuonFilter("PostCC",muonfilt)
anal_ak5_caloData.AddElectronFilter("PreCC",electronfilt)
...
BatchRun(MC,"anal_ak5_caloMC", "conf_ak5_caloMC","/vols/cms01/mstoye/Muon_Control_Oct23/Electron_Met50/",10000)
BatchRun(data, "anal_ak5_caloData", "conf_ak5_caloData","/vols/cms01/mstoye/Muon_Control_Oct23/data_Electron_Met50/",1)
