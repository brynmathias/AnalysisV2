...
#EventNoDump_LargePFMET = OP_EventNoDump("LargeMHT,"LargeMHTHT")
...
cutTreeMC.TAttach(deadECAL_MC,LepNumComLeptons)
...
cutTreeMC.TAttach(CommonMHTCut100,MHT_PFMET_Cut)
cutTreeMC.TAttach(MHT_PFMET_Cut, PFMETCut120)
cutTreeMC.TAttach(PFMETCut120,PFMTCut110)
cutTreeMC.TAttach(PFMTCut110,ttWPlottingOpsMHT120)
...
#cutTreeMC.TAttach(ttWPlottingOpsAT,PFMTCut110)
...
#BatchRun(MC,"anal_ak5_caloMC", "conf_ak5_caloMC","/vols/cms01/mstoye/Muon_Control_Oct20/MC_100_ttW/",10000)
#BatchRun([Edward_Data_Skim], "anal_ak5_caloData", "conf_ak5_caloData","/vols/cms01/mstoye/Muon_Control_Oct20/data_100_ttW/",10)
