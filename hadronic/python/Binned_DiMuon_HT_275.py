...
tree,value1,l = MakeMuonDataTree(73.)
treeMC,value2,j = MakeMuonMCTree(73.)
cutTreeData,value3,k = MakeDiMuonTree(73.)
cutTreeMC,value4,m = MakeDiMuonMCTree(73.)
...
def addCutFlowHadData(c):
 ...
 c.AddMuonFilter("PreCC",muonfilt2)
...
def addCutFlowHadMC(d):
 ...
 d.AddMuonFilter("PreCC",muonfilt2)
...
Muon_Analysis=Analysis("Muon_275")
addCutFlowMuon(Muon_Analysis)

Muon_MC=Analysis("MuonMC_275")
addCutFlowMuonMC(Muon_MC)

DiMuon_Analysis=Analysis("DiMuon_275")
addCutFlowHadData(DiMuon_Analysis)

DiMuon_MC=Analysis("DiMuonMC_275")
addCutFlowHadMC(DiMuon_MC)
...
#outdir = "../DiMuon_Prediction_"+strftime("%d_%b")+"/Muon_Data/"
#outdir = "../DiMuon_Prediction_"+strftime("%d_%b")+"/DiMuon_MC/"
DiMuonoutdir = "../DiMuon_Prediction_"+strftime("%d_%b")+"/DiMuon_Data/"
#DiMuonoutdir = "../DiMuon_Prediction_"+strftime("%d_%b")+"/DiMuon_MC/"

#ensure_dir(outdir)
ensure_dir(DiMuonoutdir)
...
DiMuon_Analysis.Run(DiMuonoutdir,confHad,[HT_Run2011AB])
#DiMuon_MC.Run(DiMuonoutdir,confHadMC, DiMuon_Sample) 
