...
cutTreeBtagMC,junkVarm,m = MakeBtagMCTree(100.,Muon = True)
...
#cutTreeBtagMC, junkVarm,m = MakeBtagMCTree(100.*(275./375.), Muon = True)
#cutTreeBtagMC, junkVarm,m = MakeBtagMCTree(100.*(325./375.), Muon = True)
...
#anal_ak5_caloBtagData.Run(outDir,conf_ak5_caloBtagData,Btag_TTbar_Sample_new)
