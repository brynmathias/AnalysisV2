...
tree,value1,l = MakeMuonDataTree(100.*(325./375.))
treeMC,value2,j = MakeMuonMCTree(100.*(325./375.))
cutTreeData,value3,k = MakeHadDataTree(100.*(325./375.))
cutTreeMC,value4,m = MakeHadMCTree(100.*(325./375.))
...
outdir = "../Binned_results_HT_325_"+strftime("%d_%b_%H")+"/Muon_Data/"
#outdir = "../Binned_results_HT_325_"+strftime("%d_%b_%H")+"/MC/"
#outdir = "../Binned_results_HT_325_"+strftime("%d_%b_%H")+"/Had_Data/"
#outdir = "../Binned_results_HT_325_"+strftime("%d_%b_%H")+"/Had_MC/"
...
Muon_Analysis.Run(outdir,conf,[HTRun2011AB])
#Muon_MC.Run(outdir,confMC, Summer11_Muon_MC)
#Had_Analysis.Run(outdir,confHad,[HTRun2011AB])
#Had_MC.Run(outdir,confHadMC, Summer11_Muon_MC)
