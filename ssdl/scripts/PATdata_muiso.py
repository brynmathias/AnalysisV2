...
samples=[ttbarTauola,qcd.qcd_pythia_pt170_jun2010]
#data=[JetMET_Run2010A_PromptReco_v4_03092010]
#data=[JetMET_ALL_upto230810]
#data=[JetMET_Run2010A_PromptReco_v4_250810]

data=[JetMET_Run2010A_PromptReco_v4_03092010]
#ttbarTauola.LastEntry =5000
a.Run("../results/PFtoPAT/distrAfterHLT",conf,data)
#a.Run("../results/muiso",conf,samples)
#BatchRun(data_new,"test","conf","/home/hep/rvolpe/susy/CMSSW_3_6_1/src/muiso/AnalysisV2/ssdl/results",10000)
